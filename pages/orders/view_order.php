			...
			if (0 < count($result)) {
				...
				<style>
					.congratulations-card {
						background: linear-gradient(135deg, #00ff35, #00cc2a, #28a745);
						background-size: 200% 200%;
						animation: gradientShift 3s ease infinite;
						border-radius: 20px;
						box-shadow: 0 15px 35px rgba(0, 255, 53, 0.3);
						border: none;
						overflow: hidden;
						position: relative;
						margin-bottom: 25px;
				...
				<div class="congratulations-card">
					<div class="congratulations-content">
						...
						<p class="congratulations-subtitle">Você acertou uma cota premiada!</p>
						
						<div class="winning-numbers">
							<div class="winning-numbers-title">🎯 Cota(s) Premiada(s):</div>
							<div class="winning-numbers-list">' . implode(' • ', $result) . '</div>
						</div>
						
						<div class="contact-info">
							<i class="bi bi-telephone-fill"></i> Em breve nossa equipe entrará em contato com você!
						</div>
					</div>
				</div>';
			}
